...
export declare function withDateContext<P extends {
    ...
    new (props: Omit<P, "dateContext">): {
        ...
        shouldComponentUpdate?(nextProps: Readonly<Omit<P, "dateContext">>, nextState: Readonly<{}>): boolean;
        ...
        componentWillReceiveProps?(nextProps: Readonly<Omit<P, "dateContext">>): void;
        UNSAFE_componentWillReceiveProps?(nextProps: Readonly<Omit<P, "dateContext">>): void;
        componentWillUpdate?(nextProps: Readonly<Omit<P, "dateContext">>, nextState: Readonly<{}>): void;
        UNSAFE_componentWillUpdate?(nextProps: Readonly<Omit<P, "dateContext">>, nextState: Readonly<{}>): void;
    };
