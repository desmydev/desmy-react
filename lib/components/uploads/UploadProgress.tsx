...
class UploadManager extends Component<UploadManagerProps, UploadManagerState> {
  ...
  render() {
    ...
    return (
      <div className="my-5">
      <div className="bg-white dark:bg-darkDialogBackground dark:text-white relative border-[1px] border-gray-100 dark:border-darkPrimaryBorder shadow-md inset-1 rounded-lg p-6 w-full max-w-md">
        <svg
